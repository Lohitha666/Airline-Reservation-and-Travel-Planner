 ...
 * @author gsric
 */
public class planAVisit extends javax.swing.JFrame {

    /**
     * Creates new form planAVisit
     */
    public planAVisit() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("DESTINATION PLANNER");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        destination dn = new destination();
        dn.setVisible(true);
        dn.pack();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        tourplanner dn = new tourplanner();
        dn.setVisible(true);
        dn.pack();
        dn.setLocationRelativeTo(null);
        dn.setDefaultCloseOperation(EXIT_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(planAVisit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new planAVisit().setVisible(true);
            }
        });
    }
